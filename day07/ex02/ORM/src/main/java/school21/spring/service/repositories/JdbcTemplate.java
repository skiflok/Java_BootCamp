...
public class JdbcTemplate {
  ...
  public static <R> R connection(SQLFunction<? super Connection, ? extends R> function)
      throws SQLException {
  ...
  public static <R> R statement(SQLFunction<? super Statement, ? extends R> function)
      throws SQLException {
    Objects.requireNonNull(function);
  ...
  public static <R> R preparedStatement(String sql,
  ...
  public static void preparedStatement(String sql, SQLConsumer<? super PreparedStatement> consumer)
      throws SQLException {
    Objects.requireNonNull(consumer);
    connection(conn -> {
      try (PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
