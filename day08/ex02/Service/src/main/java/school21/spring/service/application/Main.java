...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          "usersRepositoryJdbc.findByEmail " + usersRepositoryJdbc.findByEmail("user5@example.com")
              .orElse(null));
    ...
    try {
      ...
      System.out.println(
          "SAVE " + usersRepositoryJdbcTemplate.findById(user2.getId()).orElse(null));

      user2.setEmail("piy piy");
      usersRepositoryJdbcTemplate.update(user2);
      System.out.println(
          "UPDATE " + usersRepositoryJdbcTemplate.findById(user2.getId()).orElse(null));

      usersRepositoryJdbcTemplate.delete(user2.getId());
      System.out.println(
          "DELETE " + usersRepositoryJdbcTemplate.findById(user2.getId()).orElse(null));

      System.out.println(
          "find by email " + usersRepositoryJdbcTemplate.findByEmail("user5@example.com"));
